...
export interface AuthPasswordResetTemplateProps {
  customer: Pick<CustomerDTO, "id" | "email" | "first_name" | "last_name">;
  token: string;
}

export const AuthPasswordResetTemplate: React.FC<AuthPasswordResetTemplateProps> & {
  PreviewProps: AuthPasswordResetTemplateProps
...
AuthPasswordResetTemplate.PreviewProps = {
  customer: {
    id: "1",
...
} satisfies AuthPasswordResetTemplateProps;
