...
export default function TermsOfUsePage() {
  return (
    <Layout className="pt-30 pb-20 md:pt-47 md:pb-32">
      ...
      >
        <p>
          Welcome to Britblooms. These Terms of Use govern your access to and
        ...
        <p>
          ...
          logos, images, videos, and trademarks, are the property of Britblooms
          or its licensors and are protected by intellectual property laws. You
          may not use, reproduce, modify, or distribute any of our content
        ...
        <p>
          To the maximum extent permitted by law, Britblooms and its affiliates,
        ...
        <p>
          You agree to indemnify, defend, and hold harmless Britblooms and its
