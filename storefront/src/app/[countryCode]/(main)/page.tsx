...
export const metadata: Metadata = {
  title: "Britblooms - Shop",
  description: "Living Nature – Elevate Your Spaces with Natural Design",
}
        ...
        <Layout className="mb-26 md:mb-36">
          <LayoutColumn start={1} end={{ base: 13, md: 8 }}>
            <h3 className="text-md max-md:mb-6 md:text-2xl">
              Blending the Beauty of Nature into Everyday Living
            </h3>
          </LayoutColumn>
        </Layout>
        <ProductTypesSection />
          ...
          >
            <div className="md:text-md">
              <p className="mb-5 md:mb-9">
                We embrace the art of living nature, seamlessly blending the
                beauty of the natural world into your indoor and outdoor spaces.
              </p>
              <LocalizedLink href="/about" variant="underline">
                Read more about Britblooms
              </LocalizedLink>
            </div>
          </LayoutColumn>
        </Layout>
